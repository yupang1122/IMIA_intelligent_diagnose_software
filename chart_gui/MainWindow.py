...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolBtn_GenData.setText(_translate("MainWindow", "刷新结果"))
        self.toolBtn_Counting.setToolTip(_translate("MainWindow", "重新统计"))
        self.toolBtn_Counting.setText(_translate("MainWindow", "刷新统计"))
        ...
        self.groupBox.setTitle(_translate("MainWindow", "结果类目"))
        self.label_5.setText(_translate("MainWindow", "九分类结果"))
        self.groupBox_7.setTitle(_translate("MainWindow", "框选统计"))
        self.treeWidget.headerItem().setText(0, _translate("MainWindow", "序号"))
        self.treeWidget.headerItem().setText(1, _translate("MainWindow", "框选区域"))
        self.treeWidget.headerItem().setText(2, _translate("MainWindow", "细胞核数"))
        self.treeWidget.headerItem().setText(3, _translate("MainWindow", "面积均值"))
