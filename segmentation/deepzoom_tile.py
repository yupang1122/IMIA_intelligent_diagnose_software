...
def get_tiles(slide_name, out_folder, tile_size, magnification, ratio, target_max, target_stain_matrix, color_normalization=False):
    # normalization_target_path = 'E:/Code/HistoSlider/Ref.png'
...
def main(slide_name):
    ...
    color_norm = True
    out_folder = 'E:/Code/HistoSlider/dataprocess/slide_tiles/'
    print(slide_name, target_max, target_stain_matrix)
    get_tiles(slide_name, out_folder, tile_size, magnification_level, background_ratio, target_max, target_stain_matrix, color_norm)
